let sizes = [
    ...
    { name: "Huge", range: [244, 800], sizeMulti: 700, statBase: 80, loot: [2] },
    { name: "Massive", range: [800, 5000], sizeMulti: 800, statBase: 100, loot: [2] },
    { name: "Macro", range: [5000,100000], sizeMulti: 900, statBase: 120, loot: [2] },
    { name: "Mega-Macro", range: [100000], sizeMulti: 1000, statBase: 140, loot: [2] } 
];
...
let muscleAmount = [
    ...
    {name: "Modest", range:[80,120], singular: 'a', pecs:'a modest amount of', abs: `your firm six-pack abs`, muscleGut: true, arms: `they've become bulkier`, armsSecond: `are defined and showing growth`},
    {name: "Large", range:[120,180], singular: 'a', pecs:'a generous amount of', abs: `your washboard abs`, muscleGut: true, arms: `they're more muscle than anything else`, armsSecond: `have become the size of coconuts`},
    {name: "Herculean", range:[180,250], singular: 'a', pecs:'near demi-god like', abs: `your mythical abs`, muscleGut: true, arms: `they've become near perfect`, armsSecond: `have become as large as a soccer ball`},
    {name: "Colossal", range:[250], singular: 'a', pecs:'mountain', abs: `your absolute cheese grater abs`, arms: `even the gods would be jealous`, muscleGut: true, armsSecond: `look like boulders shaped by time and erosion`},
]
...
let penisSize = [
    {"Non-existant": {range:[0.0,0.1]}},
    {"Peanut": {range:[0.1,2.0]}},
    {"Nail": {range:[2.0,5.0]}},
    {"Bratwurst": {range:[5.0,12.0]}},
    {"Cucumber": {range:[12.0,24.0]}},
    {"Pipe": {range:[24.0,60.0]}},
    {"Baseball bat": {range:[60.0,100.0]}},
    {"Broom": {range:[100.0,200.0]}},
    {"Pole": {range:[200.0,600.0]}},
    {"House": {range:[600.0,2000.0]}},
    {"Building": {range:[2000.0,10000.0]}},
    {"Skyscraper": {range:[10000.0,60000.0]}},
    {"Mountain": {range:[60000.0,1000000.0]}},
    {"Continent": {range:[1000000.0,100000000.0]}},
    {"Earth": {range:[100000000.0]}},
]

let ballSize = [
    {"Non-existant": {range:[0.0,0.1]}},
    {"Walnut": {range:[0.1,2.0]}},
    {"Pool ball": {range:[2.0,5.0]}},
    {"Baseball": {range:[5.0,12.0]}},
    {"Cantaloupe": {range:[12.0,24.0]}},
    {"Beach Ball": {range:[24.0,60.0]}},
    {"Yoga ball": {range:[60.0,100.0]}},
    {"Zorb ball": {range:[100.0,200.0]}},
    {"Elephant": {range:[200.0,600.0]}},
    {"Boulder": {range:[600.0,2000.0]}},
    {"Building": {range:[2000.0,10000.0]}},
    {"City": {range:[10000.0,60000.0]}},
    {"Mountain": {range:[60000.0,1000000.0]}},
    {"Continent": {range:[1000000.0,100000000.0]}},
    {"Earth": {range:[100000000.0]}},
]
